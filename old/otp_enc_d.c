...
int ReceiveClientFile(int socket, int tempFd)
{
  ...
  // // Test if i can write something back
  // printf("write something to the client\n"); 
  // // int n = write(socket, "I got your message", 18);
  ...
  // // Test if i can write something back -- this does not work
  // printf("write something to the client\n"); 
  // // int n = write(socket, "I got your message", 18);
  // n = send(socket, "I got your message", 18, 0);
  // if (n < 0)
  // {
  //   error("ERROR writing to socket");
  // }
